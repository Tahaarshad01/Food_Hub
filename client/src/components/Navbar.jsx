...
import { useCart } from "../hooks/UseReducer";
                    ...
                    <div className="ml-4 flex items-center md:ml-6">
                      <Link>
                        ...
                        >
                          ...
                          <FaCartArrowDown className="h-6 w-6 text-white-500" />
                        </button>
                      </Link>
                      <span className="inline-flex items-center rounded-md mb-6 -ml-3 z-10 bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
                        {data.length}
                      </span>
                      {CartView ? (
                        <Model
